...
-- INIT SERVICES
-- ============================
INSERT INTO Service (id, name, price, status, inventory) VALUES
('e4R5t6Y7u8I9o0P1q2w', 'Trang trí tiệc cưới', 20000000, true, 100),
('r4T5y6U7i8O9p0A1s2d', 'Quay phim, chụp ảnh', 15000000, true, 100),
('f6G7h8J9k0L1z2X3c4v', 'Nhóm nhạc, DJ', 12000000, true, 100),
('b5N6m7B8v9C0x1Z2l3k', 'Dịch vụ tổ chức lễ cưới', 50000000, true, 100),
('q8W9e0R1t2Y3u4I5o6p', 'Catering tiệc cưới', 30000000, true, 100),
('a7S8d9F0g1H2j3K4l5n', 'Dịch vụ trang điểm cô dâu', 4000000, true, 100),
('z8X9c0V1b2N3m4Q5w6e', 'Thuê xe hoa', 7000000, true, 100),
